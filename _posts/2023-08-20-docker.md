...
Docker is a great straight forward way of using containerization. I'm a big fan, and use Docker to pretty much use Docker to run most of my lab. This is a guide on how to setup Docker on an **Ubuntu Linux machine**. The commands are taken directly from Docker documentation.
