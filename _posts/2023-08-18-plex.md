...
Plex and the *ARR stack include quite a bit of what I would throw under the optional applications category. Here are some and their short descriptions.

- Overseerr: You have an automated download stack and you have plex streaming media to your friends. What if instead of bugging you for a new movie they could just request it themselves and do it themselves? Overseerr allows browsing current movies and tv in a slick modern interface and requesting they be downloaded. This then speaks to your Radarr/Sonarr backend to make the request.
...
- Bazarr: This is the *ARR stack addition of downloading subtitles.
