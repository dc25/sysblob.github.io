...
`Cron` is a misspelling on the part of a developer, but was intended to represent the greek work Chronos or Chronological. A Cron job in a general sense is a command or series of commands that are meant to run in the future. This can be a one-off command or a repeated service. 
...
### Easily generating crontab lines

If you find the process of writing a crontab difficult with the asterisks and timing, there are websites which help you generate the line based off easy to use templates. The website below can provide help with that:

[crontab-generator.org](crontab-generator.org)
