...
You could write an entire book on the amount of knowledge there is to cover on Linux - and many people have. I spent a lot of time gathering and compiling all the information you'll find here. While by no means a complete guide to linux, there is a massive amount of information in this guide. As such I highly recommend you make use of the table of contents on the right hand side. Having said that, let's get linux installed for the first time if you haven't.
