...
- `Version: "2"` - You will see versioning in a lot of Docker compose files but this is deprecated. You used to specify version of Docker.
- `Services:` - specify your first container.
...
- `/home/lucyadmin/homer:www/assets` - This is considered a bind as well. We are saying the files that are located in /home/lucyadmin/homer are mounted inside the container at the location www/assets.
